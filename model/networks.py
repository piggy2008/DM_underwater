...
def define_G(opt):
    ...
    if model_opt['which_model_G'] == 'ddpm':
        ...
        from model.ddpm_trans_modules import diffusion, unet_backup
    ...
    if model_opt['which_model_G'] == 'trans_div':
        ...
        if model_opt['teacher_param'] is not None:
            teacher = unet.UNet(in_channel=model_opt['unet']['in_channel'],
                out_channel=model_opt['unet']['out_channel'],
                norm_groups=model_opt['unet']['norm_groups'],
                inner_channel=model_opt['unet']['inner_channel'],
                channel_mults=model_opt['unet']['channel_multiplier'],
    ...
    netG = diffusion.GaussianDiffusion(
        ...
        # teacher_param=model_opt['teacher_param']
    )
    # if opt['phase'] == 'train':
